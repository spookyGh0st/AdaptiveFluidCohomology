...
gcs::FaceData<double> poisson_residual_error(gcs::ManifoldSurfaceMesh &mesh, gcs::IntrinsicGeometryInterface &geom, const gcs::VertexData<double> &u, const gcs::VertexData<double> &f);
